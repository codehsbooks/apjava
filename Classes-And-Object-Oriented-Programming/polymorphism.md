...
### Downcasting
<hr>
***Downcasting*** is conversion of a reference variable's type to that of the subclass. One difference in ***downcasting***, as compared to ***upcasting***, is that you must manually downcast. Lets look at an example of this:
