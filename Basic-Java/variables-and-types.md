...
In Java we declare a character using ``char`` before the variable name, and use single quotes to identify the character literal. Here are a couple of examples:
