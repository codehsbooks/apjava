...
Variables allow us to store information such as numbers, words, or true/false expressions. Variables can be thought of as a box that has your information inside. In Java, variables are composed of three things: a name, type, and value. 
